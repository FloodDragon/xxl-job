...
/**
 * SsoAuthUserResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class SsoAuthUserResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.glodon.com/xsd/SsoAuthUser", "SsoAuthUserResponse", "ns3");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":SsoAuthUserResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SsoAuthUserResponse",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SsoAuthUserResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
			SsoAuthUserResponse object = new SsoAuthUserResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"SsoAuthUserResponse".equals(type)) {
							// find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (SsoAuthUserResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.glodon.com/xsd/SsoAuthUser", "result")
