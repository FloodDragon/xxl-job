...
/**
 * SsoAuthUserRequestType bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class SsoAuthUserRequestType implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * SsoAuthUserRequestType Namespace URI =
	 * http://www.glodon.com/xsd/SsoAuthUser Namespace Prefix = ns3
	 */
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			String namespacePrefix = registerPrefix(xmlWriter, "http://www.glodon.com/xsd/SsoAuthUser");
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":SsoAuthUserRequestType", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SsoAuthUserRequestType",
						xmlWriter);
			}

		}

		namespace = "http://www.glodon.com/xsd/SsoAuthUser";
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SsoAuthUserRequestType parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
			SsoAuthUserRequestType object = new SsoAuthUserRequestType();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"SsoAuthUserRequestType".equals(type)) {
							// find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (SsoAuthUserRequestType) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.glodon.com/xsd/SsoAuthUser", "userCode")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "userCode").equals(reader.getName())) {
					...
					object.setUserCode(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.glodon.com/xsd/SsoAuthUser", "password")
								.equals(reader.getName())
